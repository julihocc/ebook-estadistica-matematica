...
In this activity, we will solve problems similar to the one in Figure \ref{fig:2.2.1}.
...
Consider two sets $ A,B \subset S$. The corresponding Venn diagram is shown in Figure \ref{fig:2.2.3}.
...
By solving the system of equations given by \eqref{eq:2.2.1}--\eqref{eq:2.2.4}, we obtain the solution:
\begin{align}
	x_0 &= 66 \\
	x_1 &= 33 \\
	x_2 &= 70 \\
