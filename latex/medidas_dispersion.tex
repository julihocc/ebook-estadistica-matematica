...
\begin{observacion}
	En estadística es importante distinguir entre la desviación estándar de una \emph{población} y de una \emph{muestra}. Para distinguirlas, en el primer caso utilizaremos $\s$ y en el segundo continuaremos usando $s.$
