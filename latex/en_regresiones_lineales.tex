...
Both structural forms rely upon the exact same optimization principle: the \textbf{Ordinary Least Squares (OLS)} method, which estimates the model parameters by minimizing the sum of squared residual errors.
