...
\section{Funciones de masa de probabilidad discretas (PMF y soporte)}
...
\section{Función de distribución acumulada para variables aleatorias discretas (CDF)}
...
\section{Esperanza matemática y varianza en variables aleatorias discretas}

\subsection{Valor esperado de una variable aleatoria discreta}
...
\subsection{Varianza y desviación estándar discretas}
