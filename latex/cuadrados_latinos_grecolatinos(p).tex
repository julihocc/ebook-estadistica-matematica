% NOTA DE NUMERACIÓN: diseno_experimentos_anova.tex agrupa sus secciones 8.1-8.6 (incluida
% "Diseños factoriales", 8.6) en un único archivo sin separación física de \input entre 8.5 y
% 8.6, por lo que este cuaderno de problemas no puede insertarse físicamente justo después de
% 8.5 sin dividir esa teoría (fuera de alcance). En consecuencia, estos problemas compilan
% como continuación numérica de la sección 8.6 ("Introducción a diseños factoriales"), no de
% la 8.5 ("...cuadrados latinos y grecolatinos"), aunque temáticamente pertenecen a esta
% última. Ver docs/diagnostico-cuadernos-problemas-2026-07-20.md.
