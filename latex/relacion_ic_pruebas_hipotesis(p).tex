% NOTA DE NUMERACIÓN: pruebas_de_hipotesis.tex agrupa sus 3 secciones reales (7.1, 7.2, 7.3)
% en un único archivo sin separación física de \input, por lo que este cuaderno de problemas
% no puede insertarse físicamente entre 7.2 y 7.3 sin dividir esa teoría (fuera de alcance).
% En consecuencia, estos problemas compilan como continuación numérica de la sección 7.3
% ("Uso de los valores P"), no de la 7.2 ("Relación entre IC y pruebas de hipótesis"), aunque
% temáticamente pertenecen a esta última. Ver docs/diagnostico-cuadernos-problemas-2026-07-20.md.
