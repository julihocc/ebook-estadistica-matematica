...
\begin{solucion}
	\begin{enumerate}
		...
		Sir Ronald Fisher derived that applying the inverse hyperbolic tangent to the estimator $r$, the transformed variable $Z(r) = \text{artanh}(r) = \dfrac{1}{2}\ln\left(\dfrac{1+r}{1-r}\right)$ follows an asymptotically normal distribution whose mean is $Z(\rho)$ and, crucially, **whose variance is stabilized at the constant $\dfrac{1}{n-3}$, independent of the parameter**:
		\begin{align}
