...
\begin{solucion}
	...
	\begin{enumerate}
		...
		\end{align*}
		\item Verificación: $F(-\infty) = 0$ ✓, $F(+\infty) = 1$ ✓, $F$ es no decreciente en $[0, 1]$ (de $0$ a $1$) ✓.
		\item La probabilidad es:
		\begin{align*}
...
\begin{solucion}
	...
	\begin{enumerate}
		...
		\item El cuantil $q_{0.6}$ satisface $q_{0.6}/5 = 0.6$, dando $q_{0.6} = 3$. Verificación: $F(3) = 3/5 = 0.6$ ✓.
