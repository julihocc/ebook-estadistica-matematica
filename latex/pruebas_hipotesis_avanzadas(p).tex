...
\begin{solproblema}[prob:doc_dos_medias_iguales]
...
\begin{solproblema}[prob:doc_pareadas]
...
\begin{solproblema}[prob:doc_dos_proporciones]
	\textbf{Paso 1: Planteamiento de hipótesis.}
...
\begin{solproblema}[prob:doc_dos_varianzas]
...
\begin{solproblema}[prob:homogeneidad_contingencia]
...
\begin{solproblema}[prob:doc_welch_hetero]
	\begin{enumerate}
...
\begin{solproblema}[prob:doc_k_proporciones_marascuilo]
...
\begin{solproblema}[prob:doc_errores_potencia_muestra]
	\begin{enumerate}
...
\begin{solproblema}[prob:doc_desaf_lrt_wilks]
	\begin{enumerate}
...
\begin{solproblema}[prob:doc_desaf_pvalor_teorema]
	\begin{enumerate}
