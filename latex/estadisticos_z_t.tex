...
Un buen ejemplo de esto es el caso del tiempo de entrega de una pizza.  En este caso \eqref{eq:3.5.1} seguirá una distribución normal y los valores normalizados se conocerán como \emph{valores Z}.
