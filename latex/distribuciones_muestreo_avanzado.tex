...
\section{Transformación de Variables Aleatorias y Distribuciones Derivadas}
...
\section{Distribuciones Muestrales de la Media y Varianza Insesgada}
...
\section{Teorema del Límite Central: Convergencia Asintótica}
...
\section{Distribución $\chi^2$ (Chi-Cuadrada)}
...
\end{align}
Este es el \emph{estad\'istico t} que da nombre a la prueba-$t$ (secci\'on 3.6). Esta
...
\section{Distribuciones de Muestreo y Ciencia de Datos}
