...
\begin{solproblema}[prob:sklearn_fit_predict_score]
...
\begin{solproblema}[prob:sklearn_coef_intercept]
...
\begin{solproblema}[prob:sklearn_train_test_split_basico]
...
\begin{solproblema}[prob:sklearn_r2_manual_vs_score]
...
\begin{solproblema}[prob:sklearn_rfe_interpretacion]
...
\begin{solproblema}[prob:sklearn_fit_intercept_false]
...
\begin{solproblema}[prob:sklearn_svd_vs_ecuacion_normal]
...
\begin{solproblema}[prob:sklearn_rfe_costo_computacional]
...
\begin{solproblema}[prob:sklearn_pseudoinversa_deduccion]
...
\begin{solproblema}[prob:sklearn_multicolinealidad_severa_svd]
