...
provided that this \emph{integral} converges absolutely.
 ...
 \begin{ejemplo}
  \label{exmp:2.9.1}
  Suppose a game is played with a single die assumed to be fair. In this game, a player wins \$20 if a $2$ turns up; \$40 with a $4$; \$60 with a $6$; and neither wins nor loses with any other face. Find the expected amount of money the player will win.
 \end{ejemplo}
