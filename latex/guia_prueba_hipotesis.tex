...
En la fórmula anterior, $\sigma$ es la desviación estándar de la población o ocurrencias de eventos y $n$ es el número de personas en la muestra.


La probabilidad asociada con el valor $Z$ calculada en el paso $3$ se debe comparar con el nivel de significación de la prueba a determinar si la hipótesis nula será aceptada o rechazada.
...
\begin{itemize}
	...
	$H_{a}: A_{0}>20.$
	\item Desviación estándar (conocida): $\sigma=3.$
...
Esto significa que si la media fuera $A_{0}=20,$ la probabilidad de que la media muestral fuera $A=21.2$ es $\approx 0.069\%.$
