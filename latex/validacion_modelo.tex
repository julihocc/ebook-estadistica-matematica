...
Vamos a crear un modelo para entrenar los datos y evaluar el rendimiento del modelo en
...
[,]{}
Ahora, predecimos los valores de las ventas para los valores de prueba:
...
print('Comparación de modelos (R^2 promedio +/- desviación estándar):')
...
print(f'R^2 estratificado: {np.mean(r2_stratified):.4f} +/- {np.std(r2_stratified):.4f}')
\end{lstlisting}
