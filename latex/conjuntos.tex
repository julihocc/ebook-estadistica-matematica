...
En esta actividad resolveremos problemas similares al de la figura \ref{fig:2.2.1}.
...
Consideremos dos conjuntos $ A,B \subset S$. El diagrama de Venn correspondiente esta dado por la figura \ref{fig:2.2.3}.
...
Al resolver el sistema de ecuaciones dado por  \ref{eq:2.2.1}-\ref{eq:2.2.4}, obtenemos la solución:
\begin{align}
	x_0 &= 66 \\
	x_1 &= 33 \\
	x_2 &= 70 \\
