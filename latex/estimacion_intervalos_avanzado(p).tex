...
\begin{solucion}
	\begin{enumerate}
		...
		Sir Ronald Fisher dedujo que al aplicar al estimador $r$ el arcotangente hiperbólico, la variable transformada $Z(r) = \text{artanh}(r) = \dfrac{1}{2}\ln\left(\dfrac{1+r}{1-r}\right)$ sigue una distribución asintóticamente normal cuya media es $Z(\rho)$ y, lo que es fundamental, **cuya varianza es estabilizada en la constante independiente del parámetro $\dfrac{1}{n-3}$**:
		\begin{align}
