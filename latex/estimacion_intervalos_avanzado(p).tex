...
\begin{solproblema}[prob:n_media]
...
\begin{solproblema}[prob:ic_varianza]
...
\begin{solproblema}[prob:dif_medias_z_avanzado]
...
\begin{solproblema}[prob:dif_medias_indep_iguales]
...
\begin{solproblema}[prob:dif_proporciones_ab]
...
\begin{solproblema}[prob:n_proporcion]
...
\begin{solproblema}[prob:dif_medias_welch]
...
\begin{solproblema}[prob:ic_razon_varianzas]
...
\begin{solproblema}[prob:ic-desaf-fisher]
	\begin{enumerate}
...
\begin{solproblema}[prob:ic-desaf-delta-method]
	\begin{enumerate}
