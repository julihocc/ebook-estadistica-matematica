...
**Fecha:** 2026-07-18
**Estado:** Ejecutado el 2026-07-20 y verificado nuevamente el 2026-07-24
11:35:16 -06:00 (ver `CHANGELOG.md`). La numeración 1:1 con el temario
está completa; la Unidad 1 usa la ampliación pedagógica 1.1–1.6 sin sustituir
la transcripción oficial MA1001B. Este documento es histórico, no una lista
de pendientes activa.
