...
- La cantidad de problemas por sección **no es un número fijo**: se selecciona un subconjunto razonable y bien motivado (guía orientativa: **3 a 6 problemas**, típicamente 6 cuando se cubre la Taxonomía de Bloom completa, uno por nivel), priorizando variedad de ángulos/aplicaciones sobre alcanzar una cifra específica. No se rellena con problemas redundantes solo para llegar a un conteo.
