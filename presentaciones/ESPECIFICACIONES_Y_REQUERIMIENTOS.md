...
**[Actualizado 2026-07-18]** Reemplaza la taxonomía fija anterior (10 problemas, 3-3-2-2, niveles visibles). **[Refinado 2026-07-20]** Reemplaza la categorización por dificultad y el esquema de etiquetado por nombre significativo/numérico. **[Refinado 2026-07-21]** Las soluciones ya no se numeran por un contador independiente. Ver `CHANGELOG.md` para el registro de las tres decisiones.
