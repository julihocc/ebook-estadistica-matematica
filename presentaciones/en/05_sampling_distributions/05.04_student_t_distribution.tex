...
\begin{frame}{Modular Perspective --- The Next Challenge}
  ...
  \begin{block}{What We Have Built}
    Student's t completes inference when the population standard deviation is unknown.
  \end{block}
  \pause
  \begin{alertblock}{Next Step}
    The next step is Fisher's F distribution and comparisons of variances.
  \end{alertblock}
