...
\title[Probability Introduction]{Introduction to Probability}
...
\begin{frame}{Roadmap — Chapter 02: Probability Theory}
  ...
  \begin{itemize}
    \item \color{TecRojo}\textbf{02.00 Introduction to Probability \emph{(Today)}}\color{black} \pause
    \item \textbf{02.01 Set notation and partitions} \emph{(Next session)} \pause
    \item \textbf{02.02 Probability foundations} \pause
    \item \textbf{02.03 Counting techniques} \pause
    \item \textbf{02.04 Conditional probability} \pause
    \item \textbf{02.05 Bayes' theorem} \pause
    \item \textbf{02.06 Random sampling}
  \end{itemize}
  \vspace{0.8em}
  \begin{block}{Section Objective}
