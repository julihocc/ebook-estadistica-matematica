...
\begin{frame}{Classroom Exercise --- Tier 1: Fundamental (2/2)}
	\fontsize{6.3pt}{7.5pt}\selectfont
...
\begin{frame}{Classroom Exercise --- Tier 3: Analytical (1/2)}
	...
	\begin{alertblock}{Step 1: Expanding the Expectation Definition}
		...
		We apply absorption in the numerator $k\comb{K}{k} = K\comb{K-1}{k-1}$ and denominator $n\comb{N}{n} = N\comb{N-1}{n-1} \implies \comb{N}{n} = \frac{N}{n}\comb{N-1}{n-1}$.
	\end{alertblock}
\end{frame}
