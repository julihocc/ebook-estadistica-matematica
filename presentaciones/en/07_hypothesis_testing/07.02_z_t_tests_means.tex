...
\begin{frame}{In-Class Exercise --- Level 1: Fundamental (1/2)}
  \footnotesize
  \begin{block}{Problem (Statement, Problem \ref{prob:doc_dos_medias_iguales})}
...
\begin{frame}{In-Class Exercise --- Level 2: Operational (1/2)}
  \footnotesize
  \begin{block}{Problem (Statement, Problem \ref{prob:doc_welch_hetero})}
...
\begin{frame}{In-Class Exercise --- Level 3: Analytical (1/2)}
  \footnotesize
  \begin{block}{Problem --- Power and Sample Size (Statement, Problem \ref{prob:doc_errores_potencia_muestra})}
...
\begin{frame}{In-Class Exercise --- Level 4: Challenging (1/2)}
  \footnotesize
  \begin{block}{Problem --- Wilks Likelihood Ratio Test (Statement, Problem \ref{prob:doc_desaf_lrt_wilks})}
