...
\begin{frame}{Ejercicio en Clase --- Nivel 1: Fundamental (1/2)}
  \footnotesize
  \begin{block}{Problema (Enunciado, Problema \ref{prob:doc_dos_medias_iguales})}
...
\begin{frame}{Ejercicio en Clase --- Nivel 2: Operativo (1/2)}
  \footnotesize
  \begin{block}{Problema (Enunciado, Problema \ref{prob:doc_welch_hetero})}
...
\begin{frame}{Ejercicio en Clase --- Nivel 3: Analítico (1/2)}
  \footnotesize
  \begin{block}{Problema --- Potencia y Tamaño de Muestra (Enunciado, Problema \ref{prob:doc_errores_potencia_muestra})}
...
\begin{frame}{Ejercicio en Clase --- Nivel 4: Desafiante (1/2)}
  \footnotesize
  \begin{block}{Problema --- Razón de Verosimilitudes de Wilks (Enunciado, Problema \ref{prob:doc_desaf_lrt_wilks})}
