...
\begin{frame}{Laboratorio en Python: Medidas Clásicas}
  ...
  \\ Script: \texttt{\footnotesize presentaciones/code/01\_estadistica\_descriptiva/01.02\_media\_mediana\_moda.py}
...
% Slide 9B: Laboratorio de Python En Vivo (Cálculo con Pivote)
\begin{frame}{Laboratorio en Python: Cálculo con Pivote y Salida}
  Verificación algorítmica de la fórmula del pivote ($P=9$).
  \\ Script: \texttt{\footnotesize presentaciones/code/01\_estadistica\_descriptiva/01.02\_media\_mediana\_moda.py}
