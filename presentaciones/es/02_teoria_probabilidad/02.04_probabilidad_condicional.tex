...
\begin{frame}[fragile]{Laboratorio en Python: Urna sin Reemplazo (1/2)}
  ...
  \lstinputlisting[firstline=23, lastline=39]{../../code/02_teoria_probabilidad/02.04_probabilidad_condicional.py}}
\end{frame}
...
\begin{frame}[fragile]{Laboratorio en Python: Urna sin Reemplazo (2/2)}
  ...
  \vspace{0.2em}
  {\lstset{basicstyle=\fontsize{6.3pt}{7.3pt}\selectfont\ttfamily}
  \lstinputlisting[firstline=40, lastline=56]{../../code/02_teoria_probabilidad/02.04_probabilidad_condicional.py}}
\end{frame}
...
\begin{frame}[fragile]{Laboratorio en Python: Test de Independencia}
  ...
  \vspace{0.2em}
  {\lstset{basicstyle=\fontsize{6.3pt}{7.3pt}\selectfont\ttfamily}
  \lstinputlisting[firstline=75, lastline=94]{../../code/02_teoria_probabilidad/02.04_probabilidad_condicional.py}}
\end{frame}
...
\begin{frame}[fragile]{Laboratorio en Python: Paradoja de Monty Hall}
  ...
  \vspace{0.2em}
  {\lstset{basicstyle=\fontsize{6.3pt}{7.3pt}\selectfont\ttfamily}
  \lstinputlisting[firstline=119, lastline=135]{../../code/02_teoria_probabilidad/02.04_probabilidad_condicional.py}}
\end{frame}
