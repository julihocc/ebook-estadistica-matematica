...
\title[Introducción a la Probabilidad]{Sección 2.1: Introducción a la Probabilidad}
...
\begin{frame}{Hoja de Ruta — Capítulo 02: Teoría de Probabilidad}
  ...
  \begin{itemize}
    \item \color{TecRojo}\textbf{02.01 Introducción a la probabilidad \emph{(Hoy)}}\color{black} \pause
    \item \textbf{02.02 Notación de conjuntos y particiones} \emph{(Siguiente sesión)} \pause
    \item \textbf{02.03 Fundamentos y axiomas de probabilidad} \pause
