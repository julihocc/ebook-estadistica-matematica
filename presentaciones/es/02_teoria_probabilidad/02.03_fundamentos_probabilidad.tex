...
\begin{frame}{Eventos y Álgebra de Subconjuntos}
  Un \emph{evento} $A$ es cualquier subconjunto del espacio muestral ($A \subset S$). Si el resultado observado del experimento es un elemento de $A$, decimos que \emph{el evento $A$ ha ocurrido}. \pause
