...
\begin{frame}{Ejercicio en Clase --- Nivel 2: Operativo (1/2)}
  ...
  \begin{block}{Problema --- VIF (Enunciado, Problema 9.14.5)}
    Con $p=3$ predictores financieros: $R_1^2=0.85$, $R_2^2=0.55$, $R_3^2=0.30$. Calcule el VIF de cada uno, decida cuáles superan el umbral $\text{VIF}>5$, y proponga un remedio de la Sección 09.07.
  \end{block}
