...
\title[Distribución Normal]{Sección 04.06: Distribución Normal}
...
\begin{frame}{Hoja de Ruta --- Capítulo 04: Variables Aleatorias Continuas}
  ...
  \begin{itemize}\itemsep=0.08em
    ...
    \item \textbf{04.06} Distribución Normal / Gaussiana y Puntaje $Z$ \emph{(Hoy)} \pause
...
\begin{frame}[fragile]{Laboratorio en Python: PDF y Estandarización}
  \scriptsize
  Validación de $\int f = 1$, estandarización al puntaje $Z$, y verificación de la regla 68-95-99.7 (\texttt{04.06\_normal\_distribution.py}):
  \vspace{0.02cm}
